  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <h3 className="font-semibold text-gray-900 mb-2 truncate" title={bucket.name}>
          {bucket.name}
        </h3>
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex items-center justify-between">
            <span className="flex items-center space-x-1">
              ...
              <span>{bucket.objectCount || 0} files</span>
            </span>
            <span className="flex items-center space-x-1">
              <HardDrive className="w-3 h-3" />
              <span>{bucket.totalSize ? formatFileSize(bucket.totalSize) : '0 B'}</span>
            </span>
          </div>
          
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-500">{bucket.region || 'unknown'}</span>
